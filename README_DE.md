...
Dieses Projekt steht unter der [MIT-Lizenz](LICENSE). Hinweise zu NAudio und weiteren Komponenten Dritter stehen in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
